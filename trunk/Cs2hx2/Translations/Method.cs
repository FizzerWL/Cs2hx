...
namespace Cs2hx.Translations
{
    class Method : Translation
    {
        ...
        //private string ReplaceSpecialIndicators(string rawString, Program p, InvocationExpressionSyntax invoke)
        //{
        ...
        //private string ReplaceGenericVar(string rawString, Program p, InvocationExpressionSyntax invoke)
        //{
        ...
        //internal IEnumerable<ExpressionSyntax> TranslateParameters(List<ExpressionSyntax> list, InvocationExpressionSyntax invoke, Program p)
        //{
        //    //Copy it
        //    list = list.ToList();
