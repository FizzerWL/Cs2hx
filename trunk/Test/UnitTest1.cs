...
{
    private var _list:Array<system.collections.generic.KeyValuePair<K, V>> = new Array<system.collections.generic.KeyValuePair<K, V>>();
...
class Box
{
    ...
    public var IsRectangular:Bool = true;
    public var Characters:Array<Int> = [ 97, 98 ];
    public static var StaticField:system.text.StringBuilder = new system.text.StringBuilder();
    ...
    public var MultipleOne:Int = 0;
    public var MultipleTwo:Int = 0;
    public var ReadonlyInt:Int = 3;
	public var UninitializedDate:system.DateTime = new system.DateTime();
	public var UnitializedNullableInt:Nullable_Int = new Nullable_Int();
	public var UninitializedTimeSpan:system.TimeSpan = new system.TimeSpan();
	public static var StaticUninitializedDate:system.DateTime = new system.DateTime();
	public static var StaticUnitializedNullableInt:Nullable_Int = new Nullable_Int();
	public static var StaticUninitializedTimeSpan:system.TimeSpan = new system.TimeSpan();
...
{
    private var coll:Array<String> = new Array<String>();
