...
class Cs2Hx {
	...
	public static inline function StartsWith_String(str1:String, str2:String):Bool {
	...
	public static inline function EndsWith_String(str1:String, str2:String):Bool {
		return str1.substr(str1.length - str2.length) == str2;
	}
