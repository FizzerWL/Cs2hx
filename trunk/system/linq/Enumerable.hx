...
class Enumerable {
	...
	public static inline function Sum_IEnumerableSingle(a:Array<Float>):Float {
		return Sum_IEnumerableDouble(a);
	}
	...
	public static inline function Average_IEnumerableSingle(a:Array<Float>):Float {
		return Average_IEnumerableDouble(a);
	}
